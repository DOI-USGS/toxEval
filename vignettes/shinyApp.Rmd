...
All output on the Shiny app can be created directly in R itself as well. Customizing graphs and tables can be done in R. See the help file for any functions on details and example workflows.
