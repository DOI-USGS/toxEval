...
The "Exclude" sheet is optional. If used, the "Exclude" sheet needs to have a minimum of 2 columns: "CAS" and "endPoint". They can be in any order, but the first row of the sheet should be the header (column names).
