...
plot_tox_stacks(summary_bench,
                ...
                category = "Chemical", sum_logic = FALSE,
...
plot_chemical_boxplots(combo, guide_side, plot_ND = TRUE,
                       x_label = "") +
...
We can create a summary data frame that has concentrations instead of EARs as well.
