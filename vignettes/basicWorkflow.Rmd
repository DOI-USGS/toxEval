...
The provided `endPointInfo` data frame is an important tool for grouping ToxCast end points. The end points that are basically the primary key for `toxEval` analysis are in the column "assay_component_endpoint_name". 
