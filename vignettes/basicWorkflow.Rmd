...
The function `get_ACC` will convert the ACC values in the ToxCast database from units of log(uM) to units of ug/L, and reformat the data to a format that can be used in `toxEval`.
