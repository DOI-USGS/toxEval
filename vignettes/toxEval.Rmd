...
rm(AC50, AC50Converted, dataSummary, dfToPrint,endPoint,
   endPointData, maxMinSummary, maxMinSummaryNew, maxRatioBySite,
   oneSite, passiveData, ratioPassive, casnRow, commonColumns, filePath,
   i, infoColumns, maxEndPoints, maxIndexChemical, maxIndexEndpoint,
   maxRatio, minEndPoints, packagePath, siteColumns, siteColumnsIndex, unitConversion)
...
We can extend our analsis to all sites and all times. Probably the easiest way to accomplish this is to maintain the waterSamples data structure, but replace the measured values with ratios.
