...
Regularly, it is a good idea to update *ALL* of your packages in R. If using RStudio, this is done quite easily by using the Update button in the "Packages" tab. Selecting this option checks CRAN and GRAN for updates. 
