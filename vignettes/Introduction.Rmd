...
In order to get consistent EAR results, it is important to use the correct units. The `toxEval` package assumes all measured concentrations are repored in micrograms per liter ($\mu$g/L). ToxCast data is reported in log($\mu$M), so the `toxEval` package automatically performs the unit conversion.
