...
## Study sites: Tributaries  {.flexbox .vcenter .diffH2}
...
## Water quality data collected (cont.)
...
cols_WS <- colorNumeric(col_types, domain = leg_vals)
pal_WS = colorBin(col_types, comboMap$maxEAR, bins = leg_vals)

leg_vals_P <- c(0,1,3,5,7,9)#seq(0,2500, 500) # This is maxEAR scale
cols_P <- colorNumeric(col_types, domain = leg_vals)
pal_P = colorBin(col_types, mapDataPassive$maxEAR, bins = leg_vals)
...
map3 = leaflet() %>%
  ...
  addCircles(lat=comboMap$dec.lat.va[comboMap$Passive], lng=comboMap$dec.long.va[comboMap$Passive], 
             popup=paste("<b>Passive:",comboMap$Station.Name[comboMap$Passive],'</b><br/>',
  ...
  addCircles(lat=comboMap$dec.lat.va[!comboMap$Passive], lng=comboMap$dec.long.va[!comboMap$Passive], 
             popup=paste("<b>Water Samples:",comboMap$Station.Name[!comboMap$Passive],'</b><br/>',
                         "maxEAR:",sprintf("%1.1f", comboMap$maxEAR[!comboMap$Passive]),'<br/>',
                         "nChem:",comboMap$nChem[!comboMap$Passive],'<br/>',
                         "nEndPoints", comboMap$nEndPoints[!comboMap$Passive],'<br/>'),
