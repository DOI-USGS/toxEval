...
```{r  message=FALSE, echo=FALSE, fig.show='asis',fig.width=3.5,fig.height=5}
...
toxPassive <- toxPassive[1:10,1:2]
...
tradWS <- tradWS[1:10,1:2]

# pander(tradWS,row.names = FALSE, style = 'simple')
...
<div id="leftSideThird">
ToxCast<br/>
Water Samples

```{r, echo=FALSE}
toxWS_1 <- toxWS
emphasize.strong.cells(which(toxWS_1 == "PAH", arr.ind = TRUE))
pander(toxWS_1, row.names = FALSE, style = 'simple')
```
...
```{r, echo=FALSE}
toxPassive_1 <- toxPassive
emphasize.strong.cells(which(toxPassive_1 == "PAHs", arr.ind = TRUE))
pander(toxPassive_1,row.names = FALSE, style = 'simple')
```
   
</div>

<div id="rightSideThird">
WQG<br/>
Water Samples

```{r, echo=FALSE}
tradWS_1 <- tradWS
emphasize.strong.cells(which(tradWS_1 == "PAH", arr.ind = TRUE))
pander(tradWS_1,row.names = FALSE, style = 'simple')
```
...
```{r, echo=FALSE}
toxWS_2 <- toxWS
emphasize.strong.cells(which(toxWS_2 == "Pharmaceuticals", arr.ind = TRUE))
pander(toxWS_2, row.names = FALSE, style = 'simple')
```
...
```{r, echo=FALSE}
toxPassive_2 <- toxPassive
emphasize.strong.cells(which(toxPassive_2 == "Pharmaceuticals", arr.ind = TRUE))
pander(toxPassive_2,row.names = FALSE, style = 'simple')
```
...
```{r, echo=FALSE}
tradWS_2 <- tradWS
emphasize.strong.cells(which(tradWS_2 == "Pharmaceuticals", arr.ind = TRUE))
pander(tradWS_2,row.names = FALSE, style = 'simple')
```
...
```{r, echo=FALSE}
toxWS_3 <- toxWS
emphasize.strong.cells(which(toxWS_3 == "Herbicide", arr.ind = TRUE))
pander(toxWS_3, row.names = FALSE, style = 'simple')
```
...
```{r, echo=FALSE}
toxPassive_3 <- toxPassive
emphasize.strong.cells(which(toxPassive_3 == "Herbicide", arr.ind = TRUE))
pander(toxPassive_3,row.names = FALSE, style = 'simple')
```
...
```{r, echo=FALSE}
tradWS_3 <- tradWS
emphasize.strong.cells(which(tradWS_3 == "Herbicide", arr.ind = TRUE))
pander(tradWS_3,row.names = FALSE, style = 'simple')
```
