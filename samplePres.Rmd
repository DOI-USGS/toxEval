...
sizeChem <- c("1","19")
library(grid)
png("web_map_legend.png",width=300,height=70,unit="px")
par(mar=c(1,1,0,0), bg = "transparent")
plot(leg_vals,type="n",axes=FALSE,xlab="",ylab="")
grid.roundrect(width=.85, height=0.7, y=0.6, x=0.51, r=unit(0.3, "snpc"), gp=gpar(col="grey"))
legend("center",pch=21,pt.cex=c(1,3),horiz = TRUE,bty="n",
       legend=sizeChem,pt.lwd=1,y.intersp=1.2,xpd=TRUE, title="Number of Chemicals (scales with radius)")
dev.off()
...
sizeChem <- c("1","3")
library(grid)
png("web_map_legend_passive.png",width=300,height=70,unit="px")
par(mar=c(1,1,0,0), bg = "transparent")
plot(leg_vals,type="n",axes=FALSE,xlab="",ylab="")
grid.roundrect(width=.85, height=0.7, y=0.6, x=0.51, r=unit(0.3, "snpc"), gp=gpar(col="grey"))
legend("center",pch=21,pt.cex=c(1,2.2),horiz = TRUE,bty="n",
       legend=sizeChem,pt.lwd=1,y.intersp=1.2,xpd=TRUE, title="Number of Chemicals (scales with radius)")
dev.off()
...
![legend](web_map_legend_passive.png)
...
names(comboData) <- c("ToxCast:<br/>WS Chem", "ToxCast<br/>WS Class", "ToxCast<br/>Passive Chem", "ToxCast<br/>Passive Class", "WQG<br/>WS Chem", "WQG<br/>WS Class")


# pander(comboData,row.names = FALSE, style = 'rmarkdown')
...
1,4-Dichlorobenzene         Other        
   4-Octylphenol    Detergent metabolites
