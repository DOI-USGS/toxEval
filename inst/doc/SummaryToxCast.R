...
# pCodeInfo <- pCodeInfo[pCodeInfo$parameter_cd != "61947",]
...
chemSum2_passive <- chemSumm(chemicalSummary_passive)

summ1_passive <- siteSumm(chemicalSummary_passive, newSiteKey)
...
summary_display_passive <- summary_display_passive[,c(-2,-3)]
...
summary_display2_passive <- chemicalSummary_passive %>%
  mutate(site=as.character(newSiteKey[site])) %>% 
