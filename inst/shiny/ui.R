...
sidebar <- dashboardSidebar(
  sidebarMenu(
   ...
   menuItem("Summary Graphs", icon = icon("bar-chart"), tabName = "graphs"),
   menuItem("Max EAR and Frequency Table", icon = icon("bars"), tabName = "tables"),
   menuItem("Max Hits Table", icon = icon("bars"), tabName = "maxtables"),
   menuItem("Site Hit", icon = icon("barcode"), tabName = "hitTable"),
   menuItem("Endpoint Graphs", icon = icon("bar-chart"), tabName = "endpointSum"),
