...
[![Build status](https://ci.appveyor.com/api/projects/status/i2hr35abwxx85vgs?svg=true)](https://ci.appveyor.com/project/ldecicco-USGS/toxEval)
...
|----------|------------|------------|
|[Introduction](https://github.com/USGS-R/toxEval/blob/master/vignettes/Introduction.Rmd/) | `vignette("Introduction", package="toxEval")`|Introduction to the toxEval |
|[Basic Workflow](https://github.com/USGS-R/toxEval/blob/master/vignettes/basicWorkflow.Rmd/) | `vignette("basicWorkflow", package="toxEval")`|Quickstart guide to get overview of available functions |
|[Prepare Data](https://github.com/USGS-R/toxEval/blob/master/vignettes/PrepareData.Rmd/) | `vignette("PrepareData", package="toxEval")`|Guide to preparing your data for toxEval analysis|
|[Shiny App Guide](https://github.com/USGS-R/toxEval/blob/master/vignettes/shinyApp.Rmd/) | `vignette("shinyApp", package="toxEval")`|Guide to the toxEval shiny application|
